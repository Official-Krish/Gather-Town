...
describe("Authentication", () => {
    test('User is able to sign up only once', async () => {
        const username = "Krish" + Math.random(); // krish0.12331313
        const name = "krishAnand"
        const password = "12345678Krish";
    ...
    test('Signup request fails if the username is empty', async () => {
        const username = `krish-${Math.random()}` // krish-0.12312313
    ...
    test('Signin succeeds if the username and password are correct', async() => {
        const username = `krish-${Math.random()}`
        const password = "12345678828"
        const name = "krish"

        const init = await axios.post(`${BACKEND_URL}/api/v1/user/signup`, {
            name,
            username,
            password,
            role: "Admin"
...
describe("User metadata endpoint", () => {
    ...
    beforeAll(async () => {
       ...
       const r = await axios.post(`${BACKEND_URL}/api/v1/user/signup`, {
        username,
        name,
        password,
        role: "Admin"
...
describe("Space information", () => {
    ...
    test("User is not able to delete a space that doesnt exist", async () => {
        const response = await axios.delete(`${BACKEND_URL}/api/v1/spaces/randomIdDoesntExist`, {
            headers: {
                authorization: `Bearer ${userToken}`
            }
        })
    ...
    test("User is able to delete a space that does exist", async () => {
        ...
        const deleteReponse = await axios.delete(`${BACKEND_URL}/api/v1/spaces/${response.data.spaceId}`, {
            headers: {
                authorization: `Bearer ${userToken}`
            }
        })
    ...
    test("User should not be able to delete a space created by another user", async () => {
       ...
       expect(deleteReponse.status).toBe(401)
    })
    ...
    test("Admin has gets once space after", async () => {
        const spaceCreateReponse = await axios.post(`${BACKEND_URL}/api/v1/spaces`, {
            "name": "Test",
            "dimensions": "100x200",
        }, {
            headers: {
...
describe("Arena endpoints", () => {
    ...
    beforeAll(async () => {
        ...
        const spaceResponse = await axios.post(`${BACKEND_URL}/api/v1/spaces`, {
            "name": "Test",
            "dimensions": "100x200",
            "mapId": mapId
        }, {
    ...
    test("Incorrect spaceId returns a 404", async () => {
        const response = await axios.get(`${BACKEND_URL}/api/v1/spaces/123kasdk01`, {
            headers: {
                "authorization": `Bearer ${userToken}`
            }
        });
    ...
    test("Delete endpoint is able to delete an element", async () => {
        ...
        let res = await axios.delete(`${BACKEND_URL}/api/v1/spaces/element`, {
    ...
    test("Adding an element fails if the element lies outside the dimensions", async () => {
       const newResponse = await axios.post(`${BACKEND_URL}/api/v1/spaces/element`, {
            "elementId": element1Id,
            "spaceId": spaceId,
            "x": 10000,
            "y": 210000
...
describe("Websocket tests", () => {
    ...
    async function setupHTTP() {
        const username = `krish-${Math.random()}`
        const password = "12345678"
        const adminSignupResponse = await axios.post(`${BACKEND_URL}/api/v1/user/signup`, {
            username,
            name : "krish",
            password,
            role: "Admin"
        ...
        const adminSigninResponse = await axios.post(`${BACKEND_URL}/api/v1/user/signin`, {
            username,
            password
        })
